...
public class GestorConsultarDatosEmpleado    {

        private pantallaConsultarDatosEmpleado pantalla;
    ...
    public GestorConsultarDatosEmpleado(pantallaConsultarDatosEmpleado pantalla)
    {
...
*/
	...
	public ArrayList<Tupla> mostrarTipoCapacitacion()
        ...
        public boolean levantarEmpleado(int leg)
        {
            ...
            pantalla.datosDomicilioEmpleado(empleadoModif.getDomicilio().getCalle(),String.valueOf(empleadoModif.getDomicilio().getNumero()), empleadoModif.getDomicilio().getDepto(),  String.valueOf(empleadoModif.getDomicilio().getPiso()), empleadoModif.getDomicilio().getCodigoPostal(), ggl.getPaisDeProvincia(idProvincia).getNombre(), ggl.getProvinciaDeLocalidad(idLocalidad).getNombre(), ggl.getLocalidadDeBarrio(empleadoModif.getDomicilio().getBarrio().getId()).getNombre(),empleadoModif.getDomicilio().getBarrio().getNombre());
            }
            else
