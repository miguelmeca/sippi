 ...
 */
@Deprecated
public class OLD_pantallaEmitirOrdenDeCompra1 extends javax.swing.JInternalFrame implements IPantallaOrdenDeCompra {
    private OLD_GestorRegistrarRecepcionOC gestor;
    private boolean banCerrando;

    /** Creates new form pantallaEmitirOrdenDeCompra1 */
    public OLD_pantallaEmitirOrdenDeCompra1() {
        initComponents();
        banCerrando = false;
