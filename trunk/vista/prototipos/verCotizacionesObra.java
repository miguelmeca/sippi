 ...
 */
public class verCotizacionesObra extends javax.swing.JInternalFrame {

    /** Creates new form explorarCotizaciones */
    public verCotizacionesObra() {
        initComponents();
    ...
    private void test_fill_table() {
        ...
        verCotizacionesObra_celda c1 = new verCotizacionesObra_celda();
        c1.setNumeroCotizacion(153);
        c1.setRevision(1);
        c1.setFechaCreacion(new Date());
        c1.setUltimaModificacion(new Date());

        verCotizacionesObra_celda c2 = new verCotizacionesObra_celda();
        c2.setNumeroCotizacion(153);
        c2.setRevision(2);
        c2.setFechaCreacion(new Date());
        c2.setUltimaModificacion(new Date());

        verCotizacionesObra_celda c3 = new verCotizacionesObra_celda();
    ...
    {
             tableCotizaciones.setDefaultRenderer(Object.class,new verCotizacionesObra_render());
