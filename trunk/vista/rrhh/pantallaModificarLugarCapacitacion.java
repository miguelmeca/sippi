...
public class pantallaModificarLugarCapacitacion extends javax.swing.JInternalFrame implements ICallBack_v2{
    ...
    public pantallaModificarLugarCapacitacion(int id) {
        ...
        gestor = new GestorModificarLugarCapacitacion(this);
    ...
    private void habilitarVentana()
    {
        ...
        gestor.mostrarLugarCapacitacion(this.idLugar);
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/iconos/var/16x16/attachment.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(valido == true)
        {
            boolean ok = gestor.confirmarLugarCapacitacion(this.idLugar);
            if(ok)
            {
   ...
   * EG-0014 : No se pudo conectar con la DB
    ...
    public void mostrarDomicilio(String calle, int numero, int piso, String depto,String codPostal) {
        txtCalle.setText(calle);
        txtAltura.setText(String.valueOf(numero));
        txtPiso.setText(String.valueOf(piso));
        txtDepto.setText(String.valueOf(depto));
        txtCodPostal.setText(codPostal);
    }

    public void mostrarGeo(Tupla tPais, Tupla tProvincia, Tupla tLocalidad, Tupla tBarrio) {

        DefaultComboBoxModel modeloPais = (DefaultComboBoxModel) cmbPais.getModel();

        for (int i = 0; i < modeloPais.getSize(); i++)
        {
            Tupla t = (Tupla) modeloPais.getElementAt(i);
            if(t.getId()==tPais.getId())
            {
       ...
       DefaultComboBoxModel modeloProv = (DefaultComboBoxModel) cmbProvincias.getModel();

        for (int i = 0; i < modeloProv.getSize(); i++)
        {
            Tupla t = (Tupla) modeloProv.getElementAt(i);
            if(t.getId()==tProvincia.getId())
            {
       ...
       mostrarLocalidades();
        ...
        DefaultComboBoxModel modeloLoc = (DefaultComboBoxModel) cmbLocalidades.getModel();

        for (int i = 0; i < modeloLoc.getSize(); i++)
        {
            Tupla t = (Tupla) modeloLoc.getElementAt(i);
            if(t.getId()==tLocalidad.getId())
            {
        ...
        DefaultComboBoxModel modeloBarrio = (DefaultComboBoxModel) cmbBarrio.getModel();

        for (int i = 0; i < modeloBarrio.getSize(); i++)
        {
            Tupla t = (Tupla) modeloBarrio.getElementAt(i);
            if(t.getId()==tBarrio.getId())
            {
