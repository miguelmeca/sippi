...
import controlador.rrhh.GestorRegistrarAltaCapacitador;
 ...
 * @author Fran
 */
public class pantallaRegistrarAltaCapacitador extends javax.swing.JInternalFrame implements IAyuda {
    ...
    //los 2 gestores
    private GestorRegistrarAltaCapacitador gestor;
   ...
   public pantallaRegistrarAltaCapacitador(int id, ICallBack pantallaConsu)
    {
        initComponents();
        //modificar=true;
        //legajoEmpModificar=legajo;
        pantallaConsultar=pantallaConsu;
        gestor = new GestorRegistrarAltaCapacitador(this);
        ...
        this.setTitle("Registrar baja de capacitador - "+ nombre+" "+apellido);
    }
   ...
   private void habilitarVentana()
    ...
    private void btnAltaEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaEmpleadoActionPerformed
            ...
            int resp=JOptionPane.showConfirmDialog(this.getParent(),"¿Seguro que desea dar de alta al capacitador "+nombre+" "+apellido+"?","Cerrar",JOptionPane.YES_NO_OPTION);
        if(resp==JOptionPane.YES_OPTION)
        {
            
            if(gestor.altaCapacitador())
            {
                JOptionPane.showMessageDialog(this.getParent(),"Se registó correctamente el alta del capacitador","Capacitador dado de alta",JOptionPane.INFORMATION_MESSAGE);
                pantallaConsultar.actualizar(id, true);
            }
            else
            {
                JOptionPane.showMessageDialog(this.getParent(),"Ocurrio un error, no se pudo dar de alta al capacitador","Error",JOptionPane.ERROR_MESSAGE);
   ...
   /* public static void main(String args[]) {
    ...
    //Modificar Empleado
        ...
        public void datosPersonalesCapacitador(String cuil, String nmroDoc, String tipoDocumento, String nombre, String apellido, Date fechaNac, Date fechaReg,String email, String motivoBa, Date fechaBa)
        {
            this.nombre=nombre;
