...
import controlador.rrhh.GestorRegistrarAltaEmpleado;
 ...
 * @author Fran
 */
public class pantallaRegistrarAltaEmpleado extends javax.swing.JInternalFrame implements IAyuda {
    ...
    //los 2 gestores
    private GestorRegistrarAltaEmpleado gestor;
   ...
   public pantallaRegistrarAltaEmpleado(int id, ICallBack pantallaConsu)
    {
        initComponents();
        //modificar=true;
        //legajoEmpModificar=legajo;
        pantallaConsultar=pantallaConsu;
        gestor = new GestorRegistrarAltaEmpleado(this);
        ...
        this.setTitle("Registrar alta de empleado - Legajo Nº"+legajo+" - "+ nombre+" "+apellido);
    }
   ...
   private void habilitarVentana()
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Registrar alta de empleado");
        ...
        jpDatosPersonalesLayout.setHorizontalGroup(
            ...
            .addGroup(jpDatosPersonalesLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jpDatosPersonalesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblFechaBaja, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnAltaEmpleado.setText("Dar de Alta Nuevamente");
    ...
    private void btnAltaEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaEmpleadoActionPerformed
            ...
            int resp=JOptionPane.showConfirmDialog(this.getParent(),"¿Seguro que desea dar de alta al empleado "+nombre+" "+apellido+"?","Cerrar",JOptionPane.YES_NO_OPTION);
        if(resp==JOptionPane.YES_OPTION)
        {
            
            if(gestor.altaEmpleado())
            {
                JOptionPane.showMessageDialog(this.getParent(),"Se registó correctamente el alta del empleado","Empleado dado de alta",JOptionPane.INFORMATION_MESSAGE);
                pantallaConsultar.actualizar(id, true);
            }
            else
            {
                JOptionPane.showMessageDialog(this.getParent(),"Ocurrio un error, no se pudo dar de alta al empleado","Error",JOptionPane.ERROR_MESSAGE);
   ...
   /* public static void main(String args[]) {
    ...
    //Modificar Empleado
        ...
        public void datosPersonalesEmpleado(String leg,String cuil, String nmroDoc, String tipoDocumento, String nombre, String apellido, Date fechaNac, Date fechaIng,Date fechaReg,String email, String motivoBa, Date fechaBa)
        {
            this.nombre=nombre;
            ...
            {lblFechaIngreso.setText("-");}
            txaMotivo.setText(motivoBa);
            lblFechaBaja.setText(FechaUtil.getFecha(fechaBa));
            /*if(fechaBa!=null)
            {lblFechaBaja.setText(FechaUtil.getFecha(fechaBa));}
            else
            {lblFechaBaja.setText("-");}*/
    ...
    public String getResumenAyuda() {
        return "Seleccione la opcion 'Dar de alta' si desea dar de alta al empleado registrado";
    }

    public String getTituloAyuda() {
        
        return "Opción: Registrar alta de empleado";
