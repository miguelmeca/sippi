...
import vista.rrhh.pantallaConsultarDatosCapacitador;
...
public class GestorConsultarDatosCapacitador    {

        private pantallaConsultarDatosCapacitador pantalla;
    ...
    public GestorConsultarDatosCapacitador(pantallaConsultarDatosCapacitador pantalla)
    {
...
*/
	...
	public ArrayList<Tupla> mostrarTipoCapacitacion()
        ...
        public boolean levantarCapacitador(int id)
        {
            ...
            pantalla.datosDomicilioCapacitador(empleadoModif.getDomicilio().getCalle(),String.valueOf(empleadoModif.getDomicilio().getNumero()), empleadoModif.getDomicilio().getDepto(),  String.valueOf(empleadoModif.getDomicilio().getPiso()), empleadoModif.getDomicilio().getCodigoPostal(), ggl.getPaisDeProvincia(idProvincia).getNombre(), ggl.getProvinciaDeLocalidad(idLocalidad).getNombre(), ggl.getLocalidadDeBarrio(empleadoModif.getDomicilio().getBarrio().getId()).getNombre(),empleadoModif.getDomicilio().getBarrio().getNombre());
            }
            else
           ...
           // ArrayList listaFechaVen=new ArrayList<Date>();
            ...
            pantalla.tiposCapacitacionesCapacitador( listaTipoC);
