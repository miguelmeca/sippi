...
public class TaskGraphComponent extends JComponent implements ComponentListener, AdjustmentListener {
	...
	public Object findObjectOnPo(int x, int y) {
	...
	private void paintWorkerHeader(Graphics2D g2) {
		...
		FontMetrics fm = g2.getFontMetrics();
                ...
                // TODO: WORKARROUND CAMBIAR
                _headerWidth = _headerWidthIuga;

		g2.fillRect(_graphLeft-_headerWidth, _graphTop-HEADER_HEIGHT, _headerWidth, HEADER_HEIGHT);
		g2.setColor(Colors.TEXTO_COLOR);
		g2.drawString("Etapa", _graphLeft-_headerWidth + 8, _graphTop-HEADER_HEIGHT + (fm.getHeight() + HEADER_HEIGHT)/2 - fm.getDescent() );
	...
	private void paintHeaderAndWeekends(Graphics2D g2) {
		...
		Color weekEndColor = new Color(50,50,50,30); // transparent
		int x = 0, x1, x2;
