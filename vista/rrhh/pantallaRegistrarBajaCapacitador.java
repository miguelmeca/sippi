...
import controlador.rrhh.GestorRegistrarBajaCapacitador;
 ...
 * @author Fran
 */
public class pantallaRegistrarBajaCapacitador extends javax.swing.JInternalFrame implements IAyuda {
    ...
    //los 2 gestores
    private GestorRegistrarBajaCapacitador gestor;
   ...
   public pantallaRegistrarBajaCapacitador(int id, ICallBack pantallaConsu)
    {
        initComponents();
        //modificar=true;
        //legajoEmpModificar=legajo;
        pantallaConsultar=pantallaConsu;
        gestor = new GestorRegistrarBajaCapacitador(this);
   ...
   private void habilitarVentana()
    ...
    private void btnBajaEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBajaEmpleadoActionPerformed
            ...
            int resp=JOptionPane.showConfirmDialog(this.getParent(),"¿Seguro que desea dar de baja al capacitador "+nombre+" "+apellido+"?","Cerrar",JOptionPane.YES_NO_OPTION);
        if(resp==JOptionPane.YES_OPTION)
        {
            //JOptionPane.showInputDialog(this.getParent(), "Ingrese el motivo de la bajaaaaaaa");
            if(gestor.bajaCapacitador(txaMotivo.getText()))
            {
                JOptionPane.showMessageDialog(this.getParent(),"Se registó correctamente la baja del capacitador","Capacitador dado de baja",JOptionPane.INFORMATION_MESSAGE);
                pantallaConsultar.actualizar(id, true);
            }

            else
            {
                JOptionPane.showMessageDialog(this.getParent(),"Ocurrio un error, no se pudo dar de baja al capacitador","Error",JOptionPane.ERROR_MESSAGE);
